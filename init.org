...
* LSP
  ...
  Setup the core package. Update ~read-process-output-max~ to improve
  performances when communicating with LSP servers..
...
* Yasnippet
  ...
  I don't really use it, but it looks like it is necesary for lsp-mode...
